...
class Counts_Exercises:
    def rand_countsphysical(self, physicalcaulture):
        if physicalcaulture == 'Отжимание от пола':
            ...
            conclusion = counts * minutes

            final_result = '{0} подходов по {1} раз, {2} мин.'.format(number_of_approaches, counts, minutes)
            ...
            final_result = '{0} подходов, {1} раз'.format(number_of_approaches, counts)
